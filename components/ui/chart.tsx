...
function ChartTooltipContent(props: any) {
  // Recharts types vary between versions and can be strict; accept any here
  // and pull out the expected fields at runtime.
  const {
    active,
    payload,
    className,
...
function ChartLegendContent(props: any) {
  // Accept any to avoid tight coupling to Recharts' evolving types.
